...
namespace BoardGame
{
    public class GamePieceMoveDiagonalLeftState : GamePieceState
    {
        ...
        {
            Debug.Log("Move DiagonalLeft Enter");
            MoveDiagonalLeft(StateMachine.BoardManager.CurrentButton);
            StateMachine.Input.PressedConfirm += EndTurn;
        }

        public override void Exit()
        {
            Debug.Log("Move DiagonalLeft Exit");
            StateMachine.Input.PressedConfirm -= EndTurn;
        }

        void MoveDiagonalLeft(Button button)
        {
